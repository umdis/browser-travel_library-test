    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Book>().HasData(
                new Book { IdEditorial = 1, Id = 1, ISBN = "9780435910105", NumberPages = 546, Synopsis = "...", Title = "African Folktales" },
                new Book { IdEditorial = 2, Id = 2, ISBN = "9781906523374", NumberPages = 200, Synopsis = "...", Title = "984 by George Orwell" },
                new Book { IdEditorial = 2, Id = 3, ISBN = "9780394721170", NumberPages = 105, Synopsis = "...", Title = "The Lord of the Rings by J.R.R. Tolkien" },
                new Book { IdEditorial = 1, Id = 4, ISBN = "9780813190761", NumberPages = 97, Synopsis = "...", Title = "The Kite Runner by Khaled Hosseini" });
